...
HRESULT YesOrNoUIState::Init()
{
	...
	auto YesOrNoBoxImage = manager.AddImage("YesOrNoBox", L"Image/UIImage/YesOrNoUIState/YesOrNoBox.png");
	auto CursorImage = manager.AddImage("Cursor", L"Image/UIImage/YesOrNoUIState/Cursor.png");
	// UI 엘리먼트 생성
